          ...
          addedPhotos.map((link, i) => (
            <div className="h-32 flex relative" key={i}>
              ...
              <button
                ...
                className="p-2 bg-slate-600 rounded-full text-white absolute bottom-1 right-1 opacity-60  hover:opacity-100"
              >
              ...
              <button
                ...
                className="p-2 bg-slate-600 rounded-full text-white absolute bottom-1 left-1 opacity-60  hover:opacity-100"
              >
                {link === addedPhotos[0] && (
