...
const DetailPage = () => {
  ...
  return (
    <div className="bg-gray-50">
      <div className="mx-auto max-w-[1000px] px-5 pt-36 bg-gray-50 ">
        ...
        <div onClick={() => setAllPhotos(true)} className="relative my-8 grid gap-2 grid-cols-[2fr_1fr] rounded-3xl overflow-hidden cursor-pointer">
          ...
          <div>{place.photos?.[0] && <div>{place.photos?.[0] && <img className="aspect-square w-full object-cover" src={import.meta.env.VITE_API_URL + '/uploads/' + place.photos[0]} alt="places" />}</div>}</div>
          <div className="grid">
